...
public class DataTypeDefinitions {
    ...
    public static Object getDataType(String input) {
        ...
        else if (input.contains(".") && input.matches("[0-9]*")) {
            return "java.lang.Double";
        } else if (input.matches("[0-9]{2}/[0-9]{2}/[0-9]{4}") || input.matches("[0-9]{4}-[0-9]{2}-[0-9]{2}")) {

            return "java.util.Date";
        } else if (input.matches("[0-9]{2}-[a-zA-Z]*-[0-9]{2}") || input.matches("[0-9]{2}/[a-zA-Z]*/[0-9]{4}")) {
            return "java.util.Date";
